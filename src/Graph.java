...
//    public final int treasureColor = color(0, 0, 0);
//
...
//
//
//        Tile Treas = Tile.toTile(Treasure);
...
//        for(int j = 1; j <5;j++) {
//            for (int i = -5; i == 5; i++) {
//                x = (int) Treas.posNum.x - i;
//                y = (int) Treas.posNum.y - j;
//                tiles[x][y].signal = signalStrength;
//            }
//            signalStrength--;
//        }
//
